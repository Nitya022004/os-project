...
# Update database URI to use container hostname
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:postgres@db:5432/hmdbms'
...
class User(UserMixin, db.Model):
    __tablename__ = 'users'  # Explicitly set table name to avoid PostgreSQL keyword conflicts
    id=db.Column(db.Integer,primary_key=True)
